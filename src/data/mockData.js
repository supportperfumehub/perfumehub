export const mockProducts = [
    ...
    // Lattafa
    // LATTAFA
    { id: 5, name: "Khamrah", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 115, oldPrice: 140, discount: 18, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Khamrah", category: ["arabic", "spicy", "gourmand"], gender: "unisex", description: "A luxurious oriental gourmand fragrance with notes of cinnamon, praline, and vanilla.", stock: 50 },
    { id: 6, name: "Asad", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 107, oldPrice: 150, discount: 29, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Asad", category: ["arabic", "spicy"], gender: "men", description: "A bold, spicy and woody fragrance. An exceptional signature scent for men.", stock: 45 },
    { id: 7, name: "Yara", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 82, oldPrice: 100, discount: 18, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Yara", category: ["arabic", "floral", "sweet"], gender: "women", description: "A beautiful, powdery, sweet floral fragrance with tropical vibes.", stock: 60 },
    { id: 8, name: "Fakhar Black", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 100, oldPrice: 125, discount: 20, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Fakhar", category: ["arabic", "fresh", "aromatic"], gender: "men", description: "An aromatic fougere fragrance, perfect for daily wear.", stock: 40 },
    { id: 9, name: "Bade'e Al Oud", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 97, oldPrice: 120, discount: 19, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Badee", category: ["arabic", "woody", "oud"], gender: "unisex", description: "Oud for Glory. A magnificent and extremely potent oud and saffron blend.", stock: 25 },
    { id: 10, name: "Nebras", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 195, oldPrice: 255, discount: 24, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Nebras", category: ["arabic", "sweet", "vanilla"], gender: "unisex", description: "A breathtaking creamy vanilla and cacao scent.", stock: 35 },
    { id: 11, name: "Qaa'ed", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 95, oldPrice: 130, discount: 27, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Qaaed", category: ["arabic", "leather", "spicy"], gender: "men", description: "A strong, spicy leather fragrance in a golden cylinder bottle.", stock: 30 },
    { id: 12, name: "Ameer Al Oudh", brand: "Lattafa", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 90, oldPrice: 100, discount: 10, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Lattafa+Ameer", category: ["arabic", "oud", "sweet"], gender: "unisex", description: "Intense Oud. A warm, woody, and sweet vanilla oud fragrance.", stock: 40 },

    // AHMED AL MAGHRIBI
    { id: 13, name: "Kaaf", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 103, oldPrice: 117, discount: 12, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Kaaf", category: ["arabic", "fresh", "aquatic"], gender: "unisex", description: "An incredibly fresh, aquatic and long-lasting scent. One of the best fresh Arabic perfumes.", stock: 30 },
    { id: 14, name: "Marj", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "60ml / 2.0 oz", price: 176, oldPrice: 192, discount: 8, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Marj", category: ["arabic", "woody", "oriental"], gender: "unisex", description: "A rich, potent blend of spices, woods and oud. For lovers of strong, majestic fragrances.", stock: 15 },
    { id: 15, name: "Leather", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "50ml / 1.7 oz", price: 114, oldPrice: 168, discount: 32, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Leather", category: ["arabic", "leather"], gender: "men", description: "Pure, high-quality leather mixed with subtle Arabic spices.", stock: 20 },
    { id: 16, name: "Oud Classic", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "50ml / 1.7 oz", price: 119, oldPrice: 145, discount: 18, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Oud+Classic", category: ["arabic", "oud"], gender: "unisex", description: "A staple traditional classic oud for everyday wearing.", stock: 12 },
    { id: 17, name: "Blue Oud", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 102, oldPrice: 129, discount: 21, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Blue+Oud", category: ["arabic", "oud", "fresh"], gender: "unisex", description: "A unique take combining fresh marine notes with a dark oud base.", stock: 22 },
    { id: 18, name: "Oud And Roses", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "60ml / 2.0 oz", price: 149, oldPrice: 175, discount: 15, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Oud+Roses", category: ["arabic", "floral", "oud"], gender: "unisex", description: "A majestic signature blend of Turkish rose and premium oud.", stock: 18 },
    { id: 19, name: "Hirfah", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "75ml / 2.5 oz", price: 240, oldPrice: 280, discount: 14, isNew: false, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Hirfah", category: ["arabic", "fruity", "sweet"], gender: "women", description: "An intoxicating sweet fruity oriental blend, immensely powerful.", stock: 10 },
    { id: 20, name: "Summer Oud", brand: "Ahmed Al Maghribi", type: "EDP (Eau de Parfum)", size: "60ml / 2.0 oz", price: 153, oldPrice: 159, discount: 4, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=Ahmed+Summer+Oud", category: ["arabic", "fresh", "oud"], gender: "unisex", description: "A lighter, more aerated oud meant exclusively for hot summer days.", stock: 25 },

    // FRENCH AVENUE (Fragrance World)
    { id: 21, name: "Divin Asylum", brand: "French Avenue", type: "EDP (Eau de Parfum)", size: "100ml / 3.4 oz", price: 147, oldPrice: 180, discount: 18, isNew: true, image: "https://placehold.co/400x500/1a1a1a/d4af37?text=French+Ave+Divin", category: ["arabic", "fresh", "citrus"], gender: "men", description: "A vibrant fresh citrus and woody fragrance. Extremely smooth and sophisticated.", stock: 40 },
    ...
    // EXCLUSIVE ABAYAS
    {
        ...
        discount: 11,
        isNew: true,
        image: ["/assets/products/royal_velvet_abaya.webp"],
    ...
    },
    {
        ...
        discount: 0,
        isNew: true,
        image: ["/assets/products/pearl_organza_abaya.webp"],
        category: ["fashion", "abaya", "clothing"],
        gender: "women",
    ...
    },
    {
        ...
        discount: 10,
        isNew: false,
        image: ["/assets/products/linen_abaya.webp"],
        category: ["fashion", "abaya", "clothing"],
        gender: "women",
